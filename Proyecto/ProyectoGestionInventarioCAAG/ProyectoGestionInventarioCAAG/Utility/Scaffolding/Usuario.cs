...
public partial class Usuario
{
    ...
    public virtual ICollection<Sucursale> SucursaleUsuarioCreacionNavigations { get; set; } = new List<Sucursale>();

    public virtual ICollection<Sucursale> SucursaleUsuarioModificacionNavigations { get; set; } = new List<Sucursale>();
